...
KAMSTRUP_PARAM_META = {
    "energy": {"name": "Energy", "unit": "kWh", "icon": "mdi:flash"},
    "power": {"name": "Power", "unit": "W", "icon": "mdi:lightning-bolt"},
    "temp1": {"name": "Temperature 1", "unit": "°C", "icon": "mdi:thermometer"},
    "temp2": {"name": "Temperature 2", "unit": "°C", "icon": "mdi:thermometer"},
    "volume": {"name": "Volume", "unit": "m³", "icon": "mdi:water"},
    "flow": {"name": "Flow", "unit": "m³/h", "icon": "mdi:water-percent"},
    "tempdiff": {"name": "Temp Difference", "unit": "°C", "icon": "mdi:thermometer-minus"},
    "minflow_m": {"name": "Min Flow (Month)", "unit": "m³/h", "icon": "mdi:water-percent"},
    "maxflow_m": {"name": "Max Flow (Month)", "unit": "m³/h", "icon": "mdi:water-percent"},
    "minflowDate_m": {"name": "Min Flow Date (Month)", "unit": None, "icon": "mdi:calendar"},
    "maxflowDate_m": {"name": "Max Flow Date (Month)", "unit": None, "icon": "mdi:calendar"},
    "minpower_m": {"name": "Min Power (Month)", "unit": "W", "icon": "mdi:lightning-bolt"},
    "maxpower_m": {"name": "Max Power (Month)", "unit": "W", "icon": "mdi:lightning-bolt"},
    "avgtemp1_m": {"name": "Avg Temp 1 (Month)", "unit": "°C", "icon": "mdi:thermometer"},
    "avgtemp2_m": {"name": "Avg Temp 2 (Month)", "unit": "°C", "icon": "mdi:thermometer"},
    "minpowerdate_m": {"name": "Min Power Date (Month)", "unit": None, "icon": "mdi:calendar"},
    "maxpowerdate_m": {"name": "Max Power Date (Month)", "unit": None, "icon": "mdi:calendar"},
    "minflow_y": {"name": "Min Flow (Year)", "unit": "m³/h", "icon": "mdi:water-percent"},
    "maxflow_y": {"name": "Max Flow (Year)", "unit": "m³/h", "icon": "mdi:water-percent"},
    "minflowdate_y": {"name": "Min Flow Date (Year)", "unit": None, "icon": "mdi:calendar"},
    "maxflowdate_y": {"name": "Max Flow Date (Year)", "unit": None, "icon": "mdi:calendar"},
    "minpower_y": {"name": "Min Power (Year)", "unit": "W", "icon": "mdi:lightning-bolt"},
    "maxpower_y": {"name": "Max Power (Year)", "unit": "W", "icon": "mdi:lightning-bolt"},
    "avgtemp1_y": {"name": "Avg Temp 1 (Year)", "unit": "°C", "icon": "mdi:thermometer"},
    "avgtemp2_y": {"name": "Avg Temp 2 (Year)", "unit": "°C", "icon": "mdi:thermometer"},
    "minpowerdate_y": {"name": "Min Power Date (Year)", "unit": None, "icon": "mdi:calendar"},
    "maxpowerdate_y": {"name": "Max Power Date (Year)", "unit": None, "icon": "mdi:calendar"},
    "temp1xm3": {"name": "Temp 1 per m³", "unit": "°C", "icon": "mdi:thermometer"},
    "temp2xm3": {"name": "Temp 2 per m³", "unit": "°C", "icon": "mdi:thermometer"},
    "infoevent": {"name": "Info Event", "unit": None, "icon": "mdi:information"},
    "hourcounter": {"name": "Hour Counter", "unit": "h", "icon": "mdi:clock"},
}
